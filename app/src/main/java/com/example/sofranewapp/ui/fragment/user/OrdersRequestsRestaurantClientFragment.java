...
import com.example.sofranewapp.adapter.OrdersRestaurantClientRecyclerAdapter;
...
public class OrdersRequestsRestaurantClientFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_requests_restaurnt_client_sofra, container, false);
    ...
    private void onEndless() {
        ...
        restaurantClientRecyclerAdapter =
                new OrdersRestaurantClientRecyclerAdapter(ordersArrayList, getActivity(),
                        requestsRestaurantComponentFragment, KeyRequest);
