...
public class UpdateOffersRestaurantFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_add_offers_restaurnt_sofra, container, false);
    ...
    private void inti() {
        ...
        addOffersRestaurantFragmentEditNameItem.setText(getName);
        addOffersRestaurantFragmentEditDescriptionItem.setText(getDescription);
        addOffersRestaurantFragmentEditFromOfferItem.setText(getStartingAt);
        addOffersRestaurantFragmentEditToItem.setText(getEndingAt);
         // method lode image view post
        LodeImageCircle(getActivity(), getPhotoUrl, addOffersRestaurantFragmentImgItem);

        addOffersRestaurantFragmentItemProgressBar.setVisibility(View.INVISIBLE);
    }

    // get   Update Offers Restaurant
...
//        LoadData(getActivity(),USER_API_TOKEN);
        ...
        apiServerRestaurant.updateOffer(
